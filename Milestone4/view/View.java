...
public class View extends JFrame implements Observer {
	...
	/**
	 * Return skipTurn button from the PlantPanel class.
	...
	/**
	 * Return startingGame JMenuItem from the MenuBar class..
	...
	/**
	 * Return closingGame JMenuItem from the MenuBar class.
	 * @return JMenuItem -returns a JMenuItem
	 */
	...
	/**
	 * Returns the game grid from mainPanel class.
	...
	/**
	 *  Returns the plants available to choose from, from the PlantPanel class.
	...
	/**
	 * Return undoButton button from the PlantPanel class.
	 * @return JButton - returns a button
	 */
	...
	/**
	 * Return redoButton button from the PlantPanel class.
	 * @return JButton - returns a button
	 */
	...
	public JMenuItem getLoadGame(){
		return MenuBar.getLoadGame();
	}
	public JMenuItem getSaveGame(){
		return MenuBar.getSaveGame();
	}
